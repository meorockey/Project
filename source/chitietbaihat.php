...
if(isset($_GET['id']) && filter_var($_GET['id'],FILTER_VALIDATE_INT,array('min_range'=>1))){
    ...
    $query_chitietbh="select * from baihat where id ='".$id."'";
    $results_chitietbh=mysqli_query($con,$query_chitietbh);
    $chitietbaihat=mysqli_fetch_array($results_chitietbh,MYSQLI_ASSOC);
?>
<div class="container text-center">
<div class="row content">
    <div class="col-sm-8 text-left"><div class="well"><div class="bg-info">
<div id='left'>
<label>Tên bài hát: <?php echo $chitietbaihat['tenbaihat']?></label><br/>
<img src="<?php echo $chitietbaihat['anh'];?>" width='400px'/><br/>
<audio controls autoplay>
    <source src="<?php echo $chitietbaihat['link'];?>">
</audio><br/>
<label>Ca sĩ: <?php echo $chitietbaihat['tencasi']?></label>
</div></div></div></div></div>
</body>
</html>