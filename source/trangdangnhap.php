...
<nav class="navbar navbar-inverse  ">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="trangdangnhap.php"><img src="./image/nhacpro.png" class="img-responsive"></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="trangdangnhap.php"><span class="glyphicon glyphicon-home"> Trang chủ</span></a></li>
        <li class="dropdown">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="dangky.php"><span class="glyphicon glyphicon-user"></span><?php if(isset($_SESSION['username'])){echo $_SESSION['username'];}?></a></li></a></li>
...
<div class="container text-center">    
  <div class="row content">
    <div class="col-sm-8 text-left">
      <div class="well"><h1>Độc quyền</h1><div id="myCarousel" class="carousel slide" data-ride="carousel">
        <!-- Indicators -->
